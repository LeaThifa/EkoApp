...
{/* 
    Template for shopping card - The product name and price is populated from the parent element 
    "CardList.js" using props.
*/}
        ...
        <>
            ...
            <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p className="pt-1 text-gray-900 flex items-center justify-between">{price}kr</p>
